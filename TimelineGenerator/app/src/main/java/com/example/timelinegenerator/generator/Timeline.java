package com.example.timelinegenerator.generator;

import com.example.timelinegenerator.model.Course;
...
//            System.out.println(coursesFounded);
                ...
                if (courseData.session.contains(mySeason.getName())) {
                    for (String prerequisite : courseData.prerequisites) {
    ...
    private List<String> foundCourses(List<String> futureCourses, List<String> takenCourses, int index) {
        ...
        if (!coursesLeft.isEmpty()) {
            ...
            if(index == futureCourses.size()) {
                ...
                firstCourses = foundCourses(course.prerequisites, takenCourses, 0);
